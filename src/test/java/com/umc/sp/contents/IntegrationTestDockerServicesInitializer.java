...
public class IntegrationTestDockerServicesInitializer
    ...
    private static final List<ServiceConfig> SERVICES_PROPERTIES = List.of(new ServiceConfig("elasticsearch", 9200, true, Duration.ofSeconds(60)),
                                                                           new ServiceConfig("redis", 6379, true, Duration.ofSeconds(60)));
